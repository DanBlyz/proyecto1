	...
	<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
		...
		<ul class="menu-nav">
			...
			<li>
				<div class="text-center mb-10">
					...
					@auth
						...
						<div class="text-light mb-2">{{ Auth::user()->categorias->nombre }}</div>
			...
			@guest
				...
				<li class="menu-item" aria-haspopup="true">
					<a href="{{ url('Categoria/formG') }}" class="menu-link">
						<i class="far fa-edit menu-icon"></i>
						<span class="menu-text">Registra tu Negocio</span>
					</a>
				</li>
			@endguest
					...
					<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
						...
						<div class="menu-submenu">
							...
							<ul class="menu-subnav">
								...
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('Categoria/gerente') }}" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
										<span class="menu-text">Gerentes</span>
									</a>
								</li>
								<li class="menu-item" aria-haspopup="true">
									<a href="{{ url('Categoria/cliente') }}" class="menu-link">
										<i class="menu-bullet menu-bullet-dot">
											<span></span>
										</i>
